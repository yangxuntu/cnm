...
# parser.add_argument('--input_rela_dir', type=str, default='data/cocobu_rela',
...
parser.add_argument('--input_sence_dir', type=str, default='data/cocobu_sence',
                        help='path to the directory of sence features')
...
ignore = ["id", "batch_size", "beam_size", "start_from", "language_eval","memory_cell_path","input_sence_dir", "gpu"]
...
# Set sample options
loss, split_predictions, lang_stats, scores_each = eval_utils_rs3.eval_split(model, crit, loader,
    vars(opt))
...
json.dump(scores_each, open('vis/'+ 'scores_'+opt.id+opt.model[-10:-4] +'.json', 'w'))