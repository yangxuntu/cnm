...
def setup(opt):
    ...
    # DenseAtt
        ...
        model = LSTM_mem4(opt)
    elif opt.caption_model == 'mlstm_mem4':
        model = MLSTM_mem4(opt)
    elif opt.caption_model == 'lstm_mem4_up':
        model = LSTM_mem4_up(opt)
    elif opt.caption_model == 'lstm_mem5':
        model = LSTM_mem5(opt)
    elif opt.caption_model == 'lstm_mem6':
        model = LSTM_mem6(opt)
    elif opt.caption_model == 'mlstm_mem6':
        model = MLSTM_mem6(opt)
